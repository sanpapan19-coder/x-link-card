  ...
  return (
    <div className="space-y-6">
      ...
      {filteredCards.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 min-[100rem]:grid-cols-5 gap-4">
          {filteredCards.map((card) => {
            return (
              ...
              >
                ...
                {/* 情報 */}
                <div className="p-5 min-[100rem]:p-3 flex-1 min-w-0 flex flex-col justify-between space-y-4">
